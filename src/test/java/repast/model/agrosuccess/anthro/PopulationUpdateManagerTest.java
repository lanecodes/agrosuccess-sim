...
public class PopulationUpdateManagerTest {
  ...
  public void setUp() {
    ...
    this.popUpdateManager = new PopulationUpdateManager(this.popUpdateParams,
   ...
   * @return Birth rate generated by the {@code PopulationUpdateManager}
   */
   ...
   *
   * @param surplusScenario
   * @return Death rate generated by the {@code PopulationUpdateManager}
   */
