...
/**
 * Stores the information about the target state resulting from a particular
 * combination of environmental conditions stored in an EnvironmentalAntecedent
 * @author andrew
 *
 */
public class EnvironmentalConsequent<T> {
	...
	public String toString() {
		return "EnvironmentalConsequent [targetState=" + targetState
